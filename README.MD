# 🛡️ SecuWatch: Threat Detection & Response Framework (v1.1)
...
![Analytics Tab](assets/Analytics2.png)

![Apache Alerts](assets/ApacheLogs.png)

![Windows Alerts](assets/WindowsLogs.png)

![Linux Alerts](assets/LinuxLogs.png)
