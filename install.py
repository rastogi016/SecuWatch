...
def main():
    ...
    venv_bin = "venv\\Scripts\\activate" if os.name == "nt" else "source venv/bin/activate"
    ...
    if not check_command_exists("node"):
        exit_with_error("Node.js is not installed. Please install it from https://nodejs.org/")
    if not check_command_exists("npm"):
        exit_with_error("npm is not installed. Please install Node.js (npm is included).")
